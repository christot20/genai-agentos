  ...
  return (
    <div className={`chat-modal-sidebar${open ? ' open' : ''}`}>
      <div className="chat-modal-icons-group">
        ...
        {!open && <button tabIndex={-1} onClick={()=>{window.location='http://localhost:3000/chat'}} aria-label="Chat" className='chat-modal-icon'><FiMessageSquare size={32} /></button>}
      ...
      {open && (
        <div className="chat-modal-expand-content">
          <div className="chat-modal-header">
            <button className="chat-modal-btn primary" onClick={()=>{window.location='http://localhost:3000/chat'}}>New Chat <FiMessageSquare /></button>
